...
class SimpleAuth:
    ...
    def request_confirmation(self, email):
        ...
        # generate mail
        subject = "Request confirmation - {} - An Egg Wiki".format(app.config["SITE_NAME"])
    ...
    def activated_user_notify_admins(self, name, email):
        ...
        subject = "New Account Registration - {} - An Egg Wiki".format(app.config["SITE_NAME"])
    ...
    def handle_recover_password(self, email):
        ...
        if not is_valid_email(email):
            ...
            # generate mail
            subject = "Password Recovery - {} - An Egg Wiki".format(
